	...
	#define STR0060 "Selecione a data da prova"
	#define STR0061 "Espere..."
	#define STR0062 "Enviando los datos"
	#define STR0063 "Fecha DOC. ID."
	#define STR0064 "Credenc. Elector "
	#define STR0065 "Celular"
	#define STR0066 "Ano Conclusion  "
	#define STR0067 "Tipo de Ensen."
	#define STR0068 "Telefono Comercial"
	#define STR0069 "Otras Informaciones"
	#define STR0070 "Particularidad"
	#define STR0071 "Vínculo"
	#define STR0072 "Nec. Especial"
	#define STR0073 "Religion"
#else
	#ifdef ENGLISH
		#define STR0001 "back"
		...
		#define STR0033 "Use the field below to search for the Teaching Institution, and then select the correct option from the list"
		...
		#define STR0044 "Find"
		#define STR0045 "To find your street, enter your Zip Code and click Find"
		...
		#define STR0060 "Select the test date"
		#define STR0061 "Please, wait..."
		#define STR0062 "Sending data"
		#define STR0063 "ID Date"
		#define STR0064 "Voter ID Card"
		#define STR0065 "Mobile"
		#define STR0066 "Conclusion Year"
		#define STR0067 "Teaching Type"
		#define STR0068 "Phone (Business)  "
		#define STR0069 "Other information"
		#define STR0070 "Particularity"
		#define STR0071 "Link"
		#define STR0072 "Special Need "
		#define STR0073 "Religion"
	#else
		...
		#define STR0059 "Erros Encontrados"
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "Seleccione a data da prova", "Selecione a data da prova" )
		#define STR0061 "Aguarde..."
		#define STR0062 If( cPaisLoc $ "ANG|PTG", "A enviar os dados", "Enviando os dados" )
		#define STR0063 If( cPaisLoc $ "ANG|PTG", "Data B.I.", "Data RG" )
		#define STR0064 If( cPaisLoc $ "ANG|PTG", "Título De Eleitor", "Titulo de Eleitor" )
		#define STR0065 If( cPaisLoc $ "ANG|PTG", "Telemóvel", "Celular" )
		#define STR0066 If( cPaisLoc $ "ANG|PTG", "Ano De Conclusão", "Ano de Conclusao" )
		#define STR0067 If( cPaisLoc $ "ANG|PTG", "Tipo De Ensino", "Tipo de Ensino" )
		#define STR0068 "Telefone Comercial"
		#define STR0069 If( cPaisLoc $ "ANG|PTG", "Outros Dados", "Outras Informações" )
		#define STR0070 "Particularidade"
		#define STR0071 "Vínculo"
		#define STR0072 "Nec. Especial"
		#define STR0073 "Religião"
	#endif
#endif
