#ifdef SPANISH
	#define STR0001 "Update UPDPCP15"
	#define STR0002 "Creacion de la tabla SGJ - Vinculo Pedido de Venta vs. Orden de Produccion"
	...
	#define STR0008 "Este Update tiene como objetivo crear la tabla SGJ - Vinculo Pedido de Venta vs. Orden de Produccion."
	#define STR0009 " "
	...
	#define STR0056 "Actualizando la tabla de indices: "
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDPCP15"
		#define STR0002 "Creation of SGJ table - Binding Sales Order x Production Order"
		#define STR0003 "Adjustment status of each table:"
		#define STR0004 "Attention: in order to run the adjustment NO user can be using the system!"
		#define STR0005 "Update routine shall create necessary fields to use the new training."
		#define STR0006 "Before starting the update, read and accept terms and conditions herein. After accepting them, proceed with the update."
		#define STR0007 "ATTENTION"
		#define STR0008 "This update aims at creating SGJ table - Binding Sales Order x Production Order."
		#define STR0009 " "
		#define STR0010 "IMPORTANT: Dictionary is updated as not to change treatment of current system."
		#define STR0011 "Free"
		...
		#define STR0018 "I read and I'm aware"
		#define STR0019 "Code"
		...
		#define STR0033 "Wait..."
		#define STR0034 "Filtering objects for the processing..."
		...
		#define STR0042 "Adjustment performed in Company's table"
		#define STR0043 "Closure of the environment for the company"
		#define STR0044 "Log File (*LOG) |*log|"
		#define STR0045 "This LOG was automatically saved as "
		#define STR0046 "in SX directory."
		#define STR0047 "'LOG' extension was added to the file, that was saved in the chosen directory ("
		#define STR0048 "Processing sales order number"
		#define STR0049 "Initializing compatibilizer"
		#define STR0050 "Updating data bank structure"
		#define STR0051 "Updating physical structure of the files:"
		#define STR0052 "Updating file physical structure"
		#define STR0053 "Failure when updating file physical structure"
		#define STR0054 "Updating file structure:"
		#define STR0055 "Updating file structure:"
		#define STR0056 "Updating indexes table:"
	#else
		#define STR0001 "Update UPDPCP15"
		#define STR0002 "Criação da tabela SGJ - Amarração Pedido de Venda x Ordem de Produção"
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento de actualização criará os campos necessários para a utilização do novo tratamento.", "A rotina de atualização irá criar os campos necessários para a utilização do novo tratamento." )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este Update tem como objectivo criar a tabela SGJ - Amarração Pedido de Venda x Ordem de Produção.", "Este Update tem como objetivo criar a tabela SGJ - Amarração Pedido de Venda x Ordem de Produção." )
		...
		#define STR0056 If( cPaisLoc $ "ANG|PTG", "A actualizar a tabela de índices: ", "Atualizando a tabela de indices: " )
	#endif
#endif
