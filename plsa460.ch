	...
	#define STR0043 "Negar"
		...
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "Autorização Especial", "Liberacao Especial" )
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "Não foi possível localizar o cabeçalho deste evento.", "Nao foi possivel localizar o cabecalho deste evento." )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Confirmar a negação de autorização?", "Confirma a negacao da autorizacao?" )
