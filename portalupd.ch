	...
	#define STR0005 "Actualizacion del Diccionario - Portal Protheus"
	...
	#define STR0025 "Log de la actualizacion "
	...
	#define STR0036 "¡No fue posible la apertura de la tabla de empresas de forma exclusiva !"
		...
		#define STR0003 "To prevent probable update failures, make a back up of the dictionaries and the database before updating!"
		#define STR0004 "Attention!"
		#define STR0005 "Dictionary update - Protheus Portal"
		#define STR0006 "Processing"
		#define STR0007 "Please, wait. Preparing files "
		#define STR0008 "No user must be using the system during update!"
		#define STR0009 "Data update v. "
		#define STR0010 "OK"
		...
		#define STR0031 "Tables used: "
		#define STR0032 "Updating parameters ..."
		#define STR0033 "New parameters added. Please, check your configurations and functionalities: "
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Actualização Do Dicionário - Portal Protheus", "Atualização do Dicionário - Portal Protheus" )
