	...
	#define STR0030 "Campo BI_POSIPI ya registrado"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa ajusta os dicionários de dados em função do BOPS 149430. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 149430. " )
		...
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "A analisar Dicionário de Dados (SX3)...", "Analisando Dicionario de Dados..." )
		...
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Campo BI_POSIPI já registrado", "Campo BI_POSIPI já cadastrado" )
	#endif
#endif
