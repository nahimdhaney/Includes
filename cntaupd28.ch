#ifdef SPANISH
	#define STR0001 "Update CNTAGCT28"
	#define STR0002 'Implementacion de Campos en el Contrato'
	...
	#define STR0005 'La rutina implementara un campo adicional en el contrato referente al Control de Acceso.'
	...
	#define STR0008 'Este update tiene por objetivo crear en el diccionario de datos los nuevos campos necesarios para implementacion de las actualizaciones relacionadas al Contrato.'
	#define STR0009 ''
	...
	#define STR0056 'GCTUPD028'
	#define STR0057 'Implementacion del campo Validacion de Contrato y disparadores para actualizar CN9_DTFIM'
	#define STR0058 'SCKOZQ'
#else
	#ifdef ENGLISH
		#define STR0001 "Update CNTAGCT28"
		#define STR0002 'Fields implementation in the Agreement'
		...
		#define STR0005 'The routine will implement an additional field in agreement, regarding Access Control.'
		...
		#define STR0008 'This update purpose is to create necessary new fields in the data dictionary to implement updates regarding the Agreement.'
		#define STR0009 ''
		...
		#define STR0056 'GCTUPD028'
		#define STR0057 'The implementation of the field Contract Validation and triggers to update CN9_DTFIM'
		#define STR0058 'SCKOZQ'
	#else
		#define STR0001 "Update CNTAGCT28"
		#define STR0002 'Implementação de Campos no Contrato'
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", 'O procedimento implementará um campo adicional no contrato referente a Controlo de Accesso.', 'A rotina irá implementar um campo adicional no contrato referente a Controle de Acesso.' )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", 'Este update tem como objectivo criar no dicionário de dados novos campos necessários para implementação das actualizações referente o Contrato.', 'Este update tem como objetivo criar no dicionário de dados novos campos necessários para implementação das atualizações referente o Contrato.' )
		#define STR0009 ''
		...
		#define STR0056 'GCTUPD028'
		#define STR0057 'Implementação do campo Validação de Contrato e gatilhos para atualizar CN9_DTFIM'
		#define STR0058 'SCKOZQ'
	#endif
#endif
