	...
	#define STR0038 "¿A  Identif Fiscal ?"
		...
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "¨de página         ?", "¨De Pagina         ?" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "¨a  página         ?", "¨A  Pagina         ?" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "¨imprime           ?", "¨Imprime           ?" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Só livro     ", "Solo Libro     " )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Livros e actas ", "Libros y Actas " )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Só actas     ", "Solo Actas     " )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "¨imp.balanc.mensal?", "¨Imp.Balanc.Mensual?" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Sim             ", "Si             " )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "Não            ", "No             " )
		...
		#define STR0037 If( cPaisLoc $ "ANG|PTG", "¨de identificação fiscal ?", "¨De Identif Fiscal ?" )
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "¨a  identificação fiscal ?", "¨A  Identif Fiscal ?" )
	#endif
#endif
