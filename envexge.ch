#ifdef SPANISH
	#define STR0001 "Configuração invalida de Sucursal','Verificar websucursal/webempresa en los Jobs"
	...
	#define STR0010 "Para repetir la operacion solicitada , pulse el boton [Intente Nuevamente]"
	#define STR0011 "Intente Nuevamente"
	#define STR0012 "Archivo"
	#define STR0013 "no encontrado."
	#define STR0014 "Error de Apertura do Archivo "
	#define STR0015 "Cambio para "
	...
	#define STR0025 "Ocurrio un error inesperado en el procesamiento de esta pagina. El Administrador del sistema recibira notificacion de esta ocurrencia . Recomendamos especialmente que se cierre esta ventana del navegador, y se abra una nueva, para retornar al sitio."
