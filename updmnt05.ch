	...
	#define STR0010 " que sea posible su uso por otras estaciones."
	...
	#define STR0037 "¡Archivo SIGAMAT.EMP no encontrado!"
		...
		#define STR0009 " For the update, it is necessary to have exclusive access to the files"
		#define STR0010 " not being used by other workstations."
		...
		#define STR0021 "*** Inconsistency *** Unable to create file backup "
		#define STR0022 "Updating file "
		#define STR0023 "File "
		#define STR0024 " previously updated in SX2"
