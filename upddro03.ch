#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion del BOPS 147329. "
	...
	#define STR0029 "Ok"
#else
	#ifdef ENGLISH
		#define STR0001 "The purpose of this program is to adjust the data dictionary according to BOPS 147329. "
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", 'ESte programa tem como objetivo ajustar os dicionários de dados em função do BOPS 147329.', "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 147329. " )
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Verificando integridade dos dicionarios....", "Verificando integridade dos dicionários...." )
		#define STR0011 "Empresa : "
