	...
	#define STR0093 "Mensajes presentadas:"
	...
	#else
		#define STR0001 "O diretório informado no parâmetro MV_CRYSTAL está incorreto. A exportação de dados não poderá ser realizada."
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Exportação de documentos", "Exportação de Documentos" )
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Nenhum registo foi seleccionado para a criação dos dados.", "Nenhum registro foi selecionado para a geração dos dados." )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Introduzir o nome desejado para o ficheiro a ser criado (sem a extensão):", "Digite o nome desejado para o arquivo a ser gerado (sem a extensão):" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "A criar dados dos documentos seleccionados...", "Gerando dados dos documentos selecionados..." )
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Os ficheiros criados não puderam ser compactados.", "Os arquivos gerados não puderam ser compactados." )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Os dados foram criados com sucesso", "Os dados foram gerados com sucesso" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", " excepto pelos seguintes documentos não puderam ser criados:", " exceto pelos seguintes documentos não puderam ser gerados:" )
		#define STR0011 "Possíveis motivos: "
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "- o ficheiro para a criação de documentos (.rpt ou .exe) especificado no registo de documentos não existe.", "- O arquivo para a geração de documentos (.RPT ou .EXE) especificado no cadastro de Documentos não existe." )
		#define STR0013 "Sucesso"
		#define STR0014 If( cPaisLoc $ "ANG|PTG", "Os seguintes ficheiros temporários não puderam ser apagados:", "Os seguintes arquivos temporários não puderam ser apagados:" )
		#define STR0015 If( cPaisLoc $ "ANG|PTG", "Fazer a exclusão manual dos mesmos. local: ", "Faça a exclusão manual dos mesmos. Local: " )
		#define STR0016 "Informe o nome do arquivo"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "O nome do ficheiro não pode conter os seguintes caracteres: ", "O nome do arquivo não pode conter os seguintes caracteres: " )
		#define STR0018 If( cPaisLoc $ "ANG|PTG", "O nome de ficheiro indicado já existe. deseja apagá-lo e criá-lo novamente?", "O nome de arquivo informado já existe. Deseja apagá-lo e gerar novamente?" )
		#define STR0019 If( cPaisLoc $ "ANG|PTG", "O ficheiro não pode ser apagado. erro: ", "O arquivo não pôde ser apagado. Erro: " )
		#define STR0020 "Importação de dados"
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Escolher o ficheiro a ser importado:", "Escolha o arquivo a ser importado:" )
		#define STR0022 If( cPaisLoc $ "ANG|PTG", "Os ficheiros necessários para a importação de dados não puderam ser descompactados.", "Os arquivos necessários para a importação de dados não puderam ser descompactados." )
		...
		#define STR0026 If( cPaisLoc $ "ANG|PTG", "Registos cancelados pelo utilizador:", "Registros cancelados pelo usuário:" )
		#define STR0027 If( cPaisLoc $ "ANG|PTG", "Registos não importados por erro na cópia de ficheiros:", "Registros não importados por erro na cópia de arquivos:" )
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Motivo: ficheiro crystal (.rpt) já existente na pasta crystal não pode ser apagado.", "Motivo: arquivo Crystal (.RPT) já existente na pasta Crystal não pôde ser apagado." )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Operação concluída", "Operação Concluída" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Resumo Do Processamento:", "Resumo do Processamento:" )
		#define STR0031 "O "
		#define STR0032 If( cPaisLoc $ "ANG|PTG", " já se encontra registado no sistema. deseja substituí-lo?", " já se encontra cadastrado no sistema. Deseja substituí-lo?" )
		...
		#define STR0036 If( cPaisLoc $ "ANG|PTG", "O ficheiro especificado não existe.", "O arquivo especificado não existe." )
		...
		#define STR0040 If( cPaisLoc $ "ANG|PTG", "O ficheiro já esta especificado.", "O arquivo já está especificado." )
		#define STR0041 If( cPaisLoc $ "ANG|PTG", "Não há ficheiros .eru no directório especificado.", "Não há arquivos .ERU no diretório especificado." )
		#define STR0042 If( cPaisLoc $ "ANG|PTG", "O ficheiro especificado já foi escolhido.", "O arquivo especificado já foi escolhido." )
		#define STR0043 "Atenção"
		#define STR0044 "Aviso"
		#define STR0045 If( cPaisLoc $ "ANG|PTG", "A Processar Ficheiro Temporário", "Processando Arquivo Temporario" )
		#define STR0046 "Sim"
		#define STR0047 "Não"
		...
		#define STR0052 If( cPaisLoc $ "ANG|PTG", "Registo de tipos de café", "Cadastro de Tipos de Café" )
		#define STR0053 If( cPaisLoc $ "ANG|PTG", "Registo de tipos de rejeição", "Cadastro de Tipos Rejeição" )
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "Registo de condições de fixação de preço", "Cadastro de Condições de Fixação de Preço" )
		#define STR0055 If( cPaisLoc $ "ANG|PTG", "é favor indicar o mês", "Favor informar o mês" )
		#define STR0056 "Os valores devem possuir um intervalo válido."
		#define STR0057 If( cPaisLoc $ "ANG|PTG", "Valor inválido. o valor ajustado deve estar entre o valor baixo e o valor alto.", "Valor inválido. O valor Settle deve estar entre o valor Low e o valor High." )
		#define STR0058 If( cPaisLoc $ "ANG|PTG", "Código não registado no sistema", "Código não cadastrado no sistema" )
		#define STR0059 If( cPaisLoc $ "ANG|PTG", "Registo De Bebidas", "Cadastro de Bebidas" )
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "A soma das percentagens dos padrões deve totalizar 100", "A soma das porcentagens dos padrões deve totalizar 100" )
		#define STR0061 If( cPaisLoc $ "ANG|PTG", "O período actual deve ser maior que o período anterior.", "O Período Atual deve ser maior que o período anterior." )
		#define STR0062 If( cPaisLoc $ "ANG|PTG", "O mês seleccionado não é válido para a bolsa em utilização", "O Mês selecionado não é valido para a Bolsa em Uso" )
		#define STR0063 If( cPaisLoc $ "ANG|PTG", "é Favor Preencher Os Meses Na Ordem Correcta.", "Favor Preencher os Meses na Ordem Correta." )
		#define STR0064 If( cPaisLoc $ "ANG|PTG", "Nenhuma cotação foi preenchida", "Nenhuma Cotação foi Preenchida" )
		#define STR0065 If( cPaisLoc $ "ANG|PTG", "é favor preencher todos os campos da sequência ny : ", "Favor Preencher todos os campos da Sequencia NY : " )
		#define STR0066 If( cPaisLoc $ "ANG|PTG", "Os campos ny :", "Os campos NY :" )
		#define STR0067 " e "
		#define STR0068 " são iguais"
		#define STR0069 If( cPaisLoc $ "ANG|PTG", " Ny", " NY" )
		#define STR0070 If( cPaisLoc $ "ANG|PTG", " e ano: ", " e Ano: " )
		#define STR0071 If( cPaisLoc $ "ANG|PTG", "é favor preencher todos os campos da sequência lo : ", "Favor Preencher todos os campos da Sequencia LO : " )
		#define STR0072 If( cPaisLoc $ "ANG|PTG", "Os campos lo :", "Os campos LO :" )
		#define STR0073 If( cPaisLoc $ "ANG|PTG", " Lo", " LO" )
		#define STR0074 If( cPaisLoc $ "ANG|PTG", "é favor preencher todos os campos da sequência bm : ", "Favor Preencher todos os campos da Sequencia BM : " )
		#define STR0075 If( cPaisLoc $ "ANG|PTG", "Os campos bm :", "Os campos BM :" )
		#define STR0076 If( cPaisLoc $ "ANG|PTG", " Bm", " BM" )
		#define STR0077 If( cPaisLoc $ "ANG|PTG", "Já existe cotação registada para a bolsa ", "Já existe cotação cadastrada para a Bolsa " )
		#define STR0078 If( cPaisLoc $ "ANG|PTG", ", mês ", ", Mês " )
		#define STR0079 If( cPaisLoc $ "ANG|PTG", "Registo De Primeiros Dias De Aviso", "Cadastro de First Notice Days" )
		#define STR0080 "O valor do campo Mês/Ano deve ser igual ou superior à Data de Cotação"
		#define STR0081 If( cPaisLoc $ "ANG|PTG", "Indique o ano da cotação da bolsa !", "Informe o ano da cotação da bolsa !" )
		#define STR0082 "Mês da cotação da bolsa inválido !"
		#define STR0083 If( cPaisLoc $ "ANG|PTG", "O registo da tabela ### estava a ser utilizado por outro utilizador, e foi autorizado agora. deseja continuar?", "O registro da tabela ### estava sendo utilizado por outro usuário, e foi liberado agora. Deseja continuar?" )
		#define STR0084 If( cPaisLoc $ "ANG|PTG", "O registo da tabela ### está a ser utilizado por outro utilizador. deseja esperar a autorização?", "O registro da tabela ### está sendo utilizado por outro usuário. Deseja esperar a liberação?" )
		#define STR0085 "Descrição do processo não informada."
		#define STR0086 "Hora:     "
		#define STR0087 "Mensagem: "
		#define STR0088 If( cPaisLoc $ "ANG|PTG", "Título:   ", "Titulo:   " )
		#define STR0089 If( cPaisLoc $ "ANG|PTG", "Pedido:     ", "Tipo:     " )
		#define STR0090 If( cPaisLoc $ "ANG|PTG", "Registo de gravação automática de processos", "Log de gravação automática de processos" )
		#define STR0091 If( cPaisLoc $ "ANG|PTG", "Data De Criação:", "Data de Geração:" )
