	...
	#define STR044  "Docto    "
	#define STR045  "Este programa emitira el docto de entrada/salida     "
#else
	#ifdef ENGLISH
		...
		#define STR045  "Este programa emitira el docto de entrada/salida     "
	#else
		#define STR001  "Do Ticket"
		#define STR002  If( cPaisLoc $ "ANG|PTG", "Até o Ticket", "Ate o Ticket" )
		...
		#define STR010  If( cPaisLoc $ "ANG|PTG", "Fact. Saída", "NF Saida" )
		#define STR011  "Nome"
