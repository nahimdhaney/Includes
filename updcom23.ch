#ifdef SPANISH
	#define STR0001 "Update UPDCOM23"
	#define STR0002 "Realizar la Contabilidad On-Line al borrar el Pedido de compra"
	...
	#define STR0005 "La rutina de actualizacion creara el parametro y los campos necesarios para la implementacion de las actualizaciones referente a la Contabilidad On-Line al borrar el Pedido de compra"
	#define STR0006 "Antes de iniciar la actualizacion, lea y acepte los terminos y las siguientes condiciones. Despues de aceptarlos, puede continuar con la actualizacion."
	#define STR0007 "ATENCION:"
	#define STR0008 "Este update tiene como objetivo crear en el diccionario de datos parametros y nuevos campos necesarios para implementar las actualizaciones referentes a la Contabilidad On-line en la exclusión del Pedido de compra."
	#define STR0009 " "
	...
	#define STR0018 "Lei y estoy de acuerdo."
	...
	#define STR0057 "Creado nuevo indice en el diccionario de datos: "
	#define STR0058 "Creando una nueva Consulta estandar"
	#define STR0059 "Actualizando diccionario de parametros"
	#define STR0060 "No se permite ejecutar este update en el entorno CodeBase."
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM13"
		#define STR0002 "On-Line Booking when deleting the Purchase Order"
		...
		#define STR0005 "The updating procedure creates the parameter and the necessary fields for implementation of the updating related to the On-Line Booking when deleting the Purchase Order"
		...
		#define STR0008 "This update has the purpose of creating necessary new fields/tables in the data dictionary to implement updates regarding On Line Booking when deleting the Purchase Order."
		#define STR0009 " "
		...
		#define STR0060 "Executing this updating in Code Base environment is not allowed."
	#else
		#define STR0001 "Update UPDCOM23"
		#define STR0002 "Realizar a Contabilização On-Line na exclusão do Pedido de Compra"
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento de actualização criará o parâmetro e campos necessários para a implementação das actualizações referentes à Contabilização On-Line na exclusão do Pedido de Compra", "A rotina de atualização irá criar o parametro e campos necessários para a implementação das atualizações referente a Contabilização On-Line na exclusão do Pedido de Compra" )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este update tem como objectivo criar no dicionário de dados parâmetros e novos campos necessários para implementação das actualizações referentes à Contabilização On-Line na exclusão do Pedido de Compra.", "Este update tem como objetivo criar no dicionário de dados parametros e novos campos necessários para implementação das atualizações referente a a Contabilização On-Line na exclusão do Pedido de Compra." )
		...
		#define STR0060 If( cPaisLoc $ "ANG|PTG", "Não é permitido executar este update em ambiente CodeBase.", "Nao e permitido executar este update em ambiente CodeBase." )
	#endif
#endif
