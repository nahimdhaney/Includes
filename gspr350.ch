	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Realizado - do mês - acumulado", "Realizado - do mes - acumulado" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Emitir em formato do realizado do mês, com o acumulado ", "Emitir em Formato do Realizado do mes, com o acumulado " )
		#define STR0003 If( cPaisLoc $ "ANG|PTG", "Para o mapa seleccionado", "para o mapa selecionado" )
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Código de barras", "Zebrado" )
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "Administração", "Administracao" )
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "|descrição                                                                                |  saldo ant. |      mês    |  acumulado  |", "|Descricao                                                                                |  Saldo Ant. |      Mes    |  Acumulado  |" )
