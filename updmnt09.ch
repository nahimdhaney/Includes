	...
	#define STR0002 "Debe ejecutarse por medio del IDE o a traves del SIGAADV."
	...
	#define STR0038 "¿Utilizara garantia de la pieza y servicio por factura?"
#else
	#ifdef ENGLISH
		...
		#define STR0007 " This program is focused on making data dictionary compatible "
		#define STR0008 " Backup data dictionary and database. "
		#define STR0009 " For the update, it is necessary to exclusively access the files"
		#define STR0010 " withou being used by other workstations."
		#define STR0011 "Processing..."
		#define STR0012 "Further details in MNTLOG.##R."
		#define STR0013 "MNT Update completed."
		#define STR0014 "Unable to open SIGAMAT.EMP"
		#define STR0015 "Operation canceled by the user"
		...
		#define STR0021 "*** Inconsistency *** Unable to create backup for the file "
		#define STR0022 "Updating file "
		#define STR0023 "File "
		#define STR0024 " already updated in SX2"
		#define STR0025 "Index update in SINDEX "
		#define STR0026 " already made"
		#define STR0027 "Field update in SX3"
		#define STR0028 "*** Inconsistency *** Unable to create new file"
		#define STR0029 "The configuration update of fields used in SX3"
		#define STR0030 " was edited"
		#define STR0031 "Unable to open Sigamat.Emp in exclusive mode"
		#define STR0032 "Check if there are users logged on the system."
		#define STR0033 "Tables Update:"
		#define STR0034 "- Table "
		#define STR0035 " updated"
		#define STR0036 "*** Inconsistency *** Unable to open a new file "
		#define STR0037 "SIGAMAT.EMP file not found!"
		#define STR0038 "Will it use parts and services guarantee through invoice?"
	#else
		...
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "Utilizará garantia da peça e serviço via Fact.?", "Utilizará garantia da peça e serviço via NF?" )
	#endif
#endif
