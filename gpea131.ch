	...
	#define STR0041 "Se encontraron inconsistencias, por favor corrija los datos y ejecute la rutina nuevamente. Es necesario tener un período activo, de acuerdo con el procedimiento."
	...
	#define STR0046 "Actualización Tickets"
		...
		#define STR0031 "Integração com ponto ativada. Obrigatorio preencher a quantidade de vales de todos os dias da semana"
		...
		#define STR0041 "Foram encontradas inconsistencias, favor corrigir os dados e executar a rotina novamente. É preciso ter período ativo de acordo com o roteiro."
