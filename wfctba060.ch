#ifdef SPANISH
	#define STR0001 '¿Clase de valor?'
	#define STR0002 'Aprobación'
	#define STR0003 'El parámetro MV_CTHAPV no está cumplimentado'
	...
	#define STR0010 'Solicitante'
#else
	#ifdef ENGLISH
		#define STR0001 'Value Class'
		#define STR0002 'Approval'
		#define STR0003 'Parameter MV_CTHAPV is not filled out'
		...
		#define STR0010 'Solicitante'
	#else
		#define STR0001 'Classe de Valor'
		#define STR0002 'Aprovação'
		#define STR0003 'O Parâmetro MV_CTHAPV não esta preenchido'
