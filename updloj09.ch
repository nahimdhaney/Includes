#ifdef SPANISH
	#define STR0001 "Este programa tiene como objetivo ajustar los diccionarios de datos en funcion del BOPS 136491 . "
	...
	#define STR0029 "Ok"
#else
	#ifdef ENGLISH
		#define STR0001 "The purpose of this program is to adjust data dictionaries due to BOPS 136491."
		...
		#define STR0015 "Start of Structure Update "
		...
		#define STR0021 "Unknown error while updating the structure of table: "
		#define STR0022 "End of Structure Update "
		...
		#define STR0029 "Ok"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função do BOPS 136491 .", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 136491 . " )
		...
		#define STR0004 If( cPaisLoc $ "ANG|PTG", "Bops 136491", "BOPS 136491" )
