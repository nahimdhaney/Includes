#ifdef SPANISH
	#define STR0001 "Este programa imprimira el balance aux.comparativo de "
	...
	#define STR0028 "MOV.COD CLASE VAL"
	#define STR0029 "TOTAL GENERAL"
	#define STR0030 "TOTAL DE LA COLUMNA"
	#define STR0031 "CODIGO"
	#define STR0032 "DESCRIP. "
#else
	#ifdef ENGLISH
		...
		#define STR0027 "Account. Item"
		#define STR0028 "MOV.COD VAL CLASS"
		#define STR0029 "GROSS TOTAL"
		#define STR0030 "COLUMN TOTAL"
		#define STR0031 "CODE"
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "Mov.cód Classe Val", "MOV.COD CLASSE VAL" )
		#define STR0029 If( cPaisLoc $ "ANG|PTG", "Total Crial", "TOTAL GERAL" )
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Total Da Coluna", "TOTAL DA COLUNA" )
