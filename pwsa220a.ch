#ifdef SPANISH
	#define STR0001 "Mis capacitaciones"
	...
	#define STR0018 "¡No existen registros para exhibicion!"
#else
	#ifdef ENGLISH
		#define STR0001 "My training sessions"
		#define STR0002 "Normal"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Minhas capacitações", "Meus treinamentos" )
		#define STR0002 "Normal"
		...
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Página inválida.", "Pagina invalida!" )
		...
		#define STR0015 "Transferido"
		#define STR0016 "Filtrar"
		#define STR0017 If( cPaisLoc $ "ANG|PTG", "Pégina:", "Pagina:" )
