	...
	#define STR0036 "DEMONSTRATIVO DE PAGAMENTO          -           Mes.......: "
#else
	#ifdef ENGLISH
		#define STR0001 "AUTHORIZATIONS ADDED IN PERIOD   "
		#define STR0002 "Authorizations Added in the Period"
		#define STR0003 ""
		#define STR0004 ""
		...
		#define STR0011 "Income Tax Amnt"
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Autorizações Inseridas No Período", "AUTORIZACOES INCLUIDAS NO PERIODO" )
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Autorizações Inseridas No Período", "Autorizacoes Incluidas no Periodo" )
		#define STR0003 ""
		#define STR0004 ""
