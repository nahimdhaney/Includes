	...
	#define STR0049 "El archivo COMPAUDIO.dot no se encontro en el servidor."
	...
	#define STR0053 "Modifique al programa del Ms-Word para visualizar el documento o haga clic en el boton para encerrar."
		...
		#define STR0048 "COMPAUDIO.dotm file was not found in the server."
		#define STR0049 "COMPAUDIO.dot file was not found in the server."
		...
		#define STR0048 If( cPaisLoc $ "ANG|PTG", "O ficheiro COMPAUDIO.dotm não foi encontrado no servidor.", "O arquivo COMPAUDIO.dotm não foi encontrado no servidor." )
		#define STR0049 If( cPaisLoc $ "ANG|PTG", "O ficheiro COMPAUDIO.dot não foi encontrado no servidor.", "O arquivo COMPAUDIO.dot não foi encontrado no servidor." )
