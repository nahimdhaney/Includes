	...
	#define STR0047 "No existe vinculacion para esta Pieza, Funcion y Categoria en el registro de Plan de control"
		...
		#define STR0037 If( cPaisLoc $ "ANG|PTG", "O utilizador responsável é diferente do utilizador registado. para alterar ou eliminar, é necessário que o utilizador responsável seja igual ao utilizador registado.", "O usuario responsavel e diferente do usuario logado. Para alterar ou excluir, e necessario que o usuario responsavel seja igual ao usuario logado." )
		#define STR0038 If( cPaisLoc $ "ANG|PTG", "O utilizador responsável é diferente do utilizador registado. será possível apenas a visualização.", "O usuario responsavel e diferente do usuario logado. Sera possivel apenas a visualizacao." )
		#define STR0039 If( cPaisLoc $ "ANG|PTG", "O utilizador ligado não está registado no registo de utilizadores do módulo; portanto, não poderá ser o autorizador", "O usuário logado não está cadastrado no cadastro de usuários do módulo, portanto não poderá ser o aprovador" )
		#define STR0040 "Função"
		#define STR0041 "Descr. Função"
		#define STR0042 "Requisito"
		#define STR0043 "ID"
		#define STR0044 "Causas"
		#define STR0045 "Modo de Falha"
		#define STR0046 If( cPaisLoc $ "ANG|PTG", "Data Efectiva", "Data Efetiva" )
		#define STR0047 If( cPaisLoc $ "ANG|PTG", "Não existe vínculação para esta Peça, Função e Categoria no registo de Plano de Controlo", "Não existe amarração para esta Peça, Funçao e Categoria no cadastro de Plano de controle" )
	#endif
#endif
