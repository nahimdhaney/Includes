	...
	#define STR0059 "aprobada, la cual va firmada por mi, Secretario, por el Coordinador de la sesión y por todos los "
		...
		#define STR0009 "The Directors of the Company are present, as well as the other ones present, according to Record "
		...
		#define STR0016 "Investiture of components. Continuing, Commission was installed and established "
