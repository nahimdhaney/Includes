	...
	#define STR0012 "Atenc. "
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", " que compreende os lançamentos entre as datas ", " que compreende os lancamentos entre as datas " )
		#define STR0007 " e "
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Período a cancelar", "Periodo a cancelar" )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Não foram localizados lançamentos para estornar" + chr ( 13 ) + "Deseja continuar com a estorno?", "Nao foram localizados movimentos para estorno." + chr ( 13 ) + "Deseja continuar com a reversao?" )
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Aguardar a selecção dos registos.", "Aguarde a selecao dos registros." )
		#define STR0011 If( cPaisLoc $ "ANG|PTG", "Confirma Execução", "Confirma Execucao" )
