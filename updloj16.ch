	...
	#define STR0029 "Ok"
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", 'ESte programa tem como objetivo ajustar os dicionários de dados em função do BOPS 147220.', "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 147220. " )
