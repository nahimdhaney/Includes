#ifdef SPANISH
	#define STR0001 "Update UPDCOM12"
	#define STR0002 "Atualização de Grupo de Campos"
	#define STR0003 "Progreso del ajuste de cada tabela:"
	#define STR0004 "Atencion: para que pueda efectuarse el ajuste ¡NINGUN usuario puede estar utilizando el sistema!"
	#define STR0005 "La rutina actualizara el grupo de campos referente al modulo Sigacom."
	...
	#define STR0008 "Este update tiene como objetivo actualizar el diccionario de datos referente a los campos del módulo Sigacom en el grupo de campos."
	#define STR0009 " "
	...
	#define STR0050 "Actualizando estrutura de la base de datos"
	#define STR0051 "Actualizada la estructura fisica de los archivos:"
	#define STR0052 "Atualizando estructura fisica del archivo "
	#define STR0053 "Falla al actualizar la estructura fisica del archivo "
	#define STR0054 "Actualizando la estructura del archivo "
	#define STR0055 "Actualizada la estrutura del archivo: "
#else
	#ifdef ENGLISH
		#define STR0001 "Update UPDCOM12"
		#define STR0002 "Update of Field Group"
		#define STR0003 "Progress of adjustment to each table:"
		#define STR0004 "Attention: in order to perform the adjustment NO user is allowed to use the system at the moment!"
		#define STR0005 "The routine will update the group of fields related to the SigaCom module."
		#define STR0006 "Before running the update, read and accept terms and conditions herein. After accepting them, continue the update."
		#define STR0007 "ATTENTION:"
		#define STR0008 "This update purports to update the data dictionary related to SigaCom module fields in fields group."
		#define STR0009 " "
		#define STR0010 "IMPORTANT: Dictionary is updated as not to change system current treatment."
		#define STR0011 "Free"
		...
		#define STR0018 "I read and I am aware."
		#define STR0019 "Code"
		#define STR0020 "Company"
		#define STR0021 "Total processing of the adjustment:"
		#define STR0022 "Updates performed:"
		#define STR0023 "Execution of the adjustment"
		#define STR0024 "Partial processing of the adjustment:"
		#define STR0025 "Concluded adjustment!"
		#define STR0026 "Tables Adjustment concluded!"
		#define STR0027 "Select the company"
		#define STR0028 "Save Log"
		#define STR0029 "&Conclude"
		#define STR0030 "SIGAMAT.EMP in use!"
		#define STR0031 "Running compatibilizer for the company:"
		...
		#define STR0040 "Update file"
		#define STR0041 "/ Branch:"
		#define STR0042 "Adjustment performed in company's tables"
		#define STR0043 "closing the environment for the company"
		#define STR0044 "Log Files (*.LOG)|*.log|"
		#define STR0045 "This LOG was automatically saved as"
		#define STR0046 "in SXs directory."
		#define STR0047 "LOG extension was added to the file, saved in chosen directory("
		#define STR0048 "Free"
		#define STR0049 "Starting compatibilizer"
		#define STR0050 "Updating database structure"
		#define STR0051 "Files physical structure is updated:"
		#define STR0052 "Updating file physical structure"
		#define STR0053 "Error when updating file physical structure"
		#define STR0054 "Updating file structure"
		#define STR0055 "File structure was updated:"
	#else
		#define STR0001 "Update UPDCOM12"
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Actualização de Grupo de Campos", "Atualização de Grupo de Campos" )
		...
		#define STR0005 If( cPaisLoc $ "ANG|PTG", "O procedimento actualizará o grupo de campos referente ao módulo SigaCom.", "A rotina irá atualizar o grupo de campos referente o módulo SigaCom." )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este update tem como objectivo actualizar o dicionário de dados referente aos campos do módulo SigaCom no grupo de campos.", "Este update tem como objetivo atualizar o dicionário de dados referente a campos do módulo SigaCom no grupo de campos." )
		...
		#define STR0043 If( cPaisLoc $ "ANG|PTG", "A fechar ambiente para a empresa ", "Encerrando ambiente para a empresa " )
		...
		#define STR0054 If( cPaisLoc $ "ANG|PTG", "A actualizat a estrutura do ficheiro ", "Atualizando a estrutura do arquivo " )
