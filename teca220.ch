	...
	#define STR0009 "Busc."
		...
		#define STR0006 If( cPaisLoc $ "ANG|PTG", "Contrato De Manutenção Preventiva", "Contrato de Manutencao Preventiva" )
		#define STR0007 If( cPaisLoc $ "ANG|PTG", "Equipamentos Com Contrato De Manutenção Preventiva", "Equipamentos com Contrato de Manutencao Preventiva" )
		#define STR0008 "Cliente: "
		#define STR0009 "Pesq."
	#endif
#endif
