	...
	#define STR0058 "Ajustada validacion del campo "
	...
	#else
		#define STR0001 "Update UPDPCP14"
		#define STR0002 If( cPaisLoc $ "ANG|PTG", "Composição do saldo do empenho, no estorno da produção para OP encerradas", "Composição do saldo do empenho, no estorno da produção para OP's encerradas" )
		...
		#define STR0008 If( cPaisLoc $ "ANG|PTG", "Este Update tem como objectivo criar os campos: D4_SLDEMP e D4_SLDEMP2. O programa contemplado por esta implementação é: Registo de Produção (MATA250).", "Este Update tem como objetivo criar os campos: D4_SLDEMP e D4_SLDEMP2. O programa contemplado por esta implementação é: Apontamento de Produção (MATA250)." )
		#define STR0009 If( cPaisLoc $ "ANG|PTG", "Estes novos campos a serem criados no dicionário, permitirão a composição do saldo do empenho após o encerramento da OP, através do procedimento de estorno de produção.", "Estes novos campos a serem criados no dicionário, irão permitir a composição do saldo do empenho após o encerramento da OP, através da rotina de estorno de produção." )
