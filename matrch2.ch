	...
	#define STR0017 "Totales Notas de Crédito: "
	...
	#define STR0032 "A N U L A D A     "
	...
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Emissão Do Livro Fiscal De Vendas", "Emissão do Livro Fiscal de Vendas" )
		...
		#define STR0011 "Empresa: "
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Página num.: ", "Página Num.: " )
		#define STR0013 If( cPaisLoc $ "ANG|PTG", "Tipo  Série Comprovativo   Segurança Social         R.u.t.                   Líq. Gravado                Iva R.g                Iva Incl.              Iva C/ret.                  Isento                   Total", "Tipo  Série Comprovante   Razão Social         R.U.T.                   Liq. Gravado                IVA R.G                IVA INCL.              IVA C/RET.                  ISENTO                   TOTAL" )
		...
		#define STR0021 If( cPaisLoc $ "ANG|PTG", "Fórmulario está posicionado?", "¿Formulário está posicionado?" )
		#define STR0022 "Sim"
		#define STR0023 "Não"
