	...
	#define STR0029 "Ok"
		...
		#define STR0029 "OK"
	#else
		#define STR0001 If( cPaisLoc $ "ANG|PTG", "Este programa tem como objectivo ajustar os dicionários de dados em função do BOPS 132160. ", "Este programa tem como objetivo ajustar os dicionários de dados em função do BOPS 132160. " )
		...
		#define STR0011 "Empresa : "
		#define STR0012 If( cPaisLoc $ "ANG|PTG", "Inicio - Dicionário de Dados", "Inicio - Dicionario de Dados" )
		...
		#define STR0028 If( cPaisLoc $ "ANG|PTG", "No foi possível a abertura da tabela de empresas de forma exclusiva !", "Nao foi possivel a abertura da tabela de empresas de forma exclusiva !" )
		#define STR0029 "Ok"
	#endif
#endif
