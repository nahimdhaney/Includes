	...
	#define STR0031 " Por favor, verifique el parámetro MV_RELACNT"
	#define STR0032 " Por favor, verifique si el empleado tiene el E-mail registrado en el sistema."
	#define STR0033 " ¡Envío de e-mail anulado!"
	#define STR0034 "Destinatario del e-mail no informado."
	#define STR0035 "¡Servidor SMTP no informado! Por favor, verifique el parámetro MV_RELSERV."
	#define STR0036 "¡Atención!"
	#define STR0037 "Verifique los parámetros de configuración: "
	#define STR0038 "MV_RELAUSR y MV_RELAUTH."
#else
	#ifdef ENGLISH
		...
		#define STR0031 " Please, check parameter MV_RELACNT"
		#define STR0032 " Please, check whether the employee has e-mail registered in the system."
		#define STR0033 " E-mail sending canceled!"
		#define STR0034 "E-mail addressee not entered."
		#define STR0035 "SMTP server not configured. Please, check parameter MV_RELSERV."
		#define STR0036 "Attention!"
		#define STR0037 "Check configuration parameters: "
		#define STR0038 "MV_RELAUSR and MV_RELAUTH."
	#else
		#define STR0001 "Empresa"
		...
		#define STR0031 " Favor, verificar parâmetro MV_RELACNT"
		#define STR0032 " Favor, verificar se o funcionário possui E-mail cadastrado no sistema."
		#define STR0033 " Envio de E-mail cancelado!"
		#define STR0034 "Destinatário do E-mail não informado."
		#define STR0035 "Servidor SMTP não informado! Favor, verificar parâmetro MV_RELSERV."
		#define STR0036 "Atenção!"
		#define STR0037 "Verifique os parâmetros de configuração: "
		#define STR0038 "MV_RELAUSR e MV_RELAUTH."
	#endif
#endif
