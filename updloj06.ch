	...
	#define STR0033 "Nº Tarjeta"
	#define STR0034 "Nº Tarjeta Superior"
#else
	#ifdef ENGLISH
		...
		#define STR0029 "Ok"
		#define STR0030 If( cPaisLoc $ "ANG|PTG", "Tp. validação", "Tp.Validacao" )
		#define STR0031 If( cPaisLoc $ "ANG|PTG", "Pedido De Validação", "Tipo de Validacao" )
		#define STR0032 If( cPaisLoc $ "ANG|PTG", "1=palavra-passe; 2=cartão; 3=ambos", "1=Senha;2=Cartao;3=Ambos" )
		#define STR0033 If( cPaisLoc $ "ANG|PTG", "Num. Cartão", "Num. Cartao" )
		#define STR0034 If( cPaisLoc $ "ANG|PTG", "Num. Cartão Superior", "Num. Cartao Superior" )
	#endif
#endif
