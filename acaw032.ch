	...
	#define STR0035 "AMG"
#else
	#ifdef ENGLISH
		#define STR0001 "Invalid Mark!"
		#define STR0002 "The valid marks are"
		#define STR0003 "Choose the evaluation  "
		...
		#define STR0025 "There are no students under home schooling for this class."
