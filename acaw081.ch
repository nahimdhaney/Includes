	...
	#define STR0009 "No se encontro horario de clase."
	#define STR0010 "Listar Archivos de Apoyo "
	...
	#define STR0023 "Periodo"
		...
		#define STR0010 "List Supporting Files"
		...
		#define STR0010 If( cPaisLoc $ "ANG|PTG", "Listar ficheiros de apoio ", "Listar Arquivos de Apoio " )
