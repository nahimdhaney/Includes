#ifdef SPANISH
	#define STR0001 "Consulta Saldos en la Fecha - Cubos"
	...
	#define STR0051 "Otros"
		...
		#define STR0039 "Series Cube Config."
		...
		#define STR0045 "TOTAL"
		#define STR0046 "Display/Hide Chart"
		#define STR0047 "Chart"
		#define STR0048 "Inconsistencies found between the movements and the first cube level file. Series total will not be displayed."
		#define STR0049 "Print/Generate Chart in BMP format"
